...
public struct ItemSelection
{
	...
	public ItemSelection(int id, bool selected)
    {
		ID = id;
		Selected = selected;
    }
...
public class CleaningTreeView : TreeView
{
    public static List<TreeViewItem> treeViewItems;
    public static ItemSelection[] itemSelections;

    public CleaningTreeView(TreeViewState treeViewState, List<TreeViewItem> tree) : base(treeViewState)
    {
        treeViewItems = tree;
